        ...
        <li className="nav-item mb-1">
          ...
          <div className="collapse" id="inventory-collapse">
            <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
              <li><NavLink to="/products/kebayas" className={`link-body-emphasis d-inline-flex text-decoration-none rounded ${isCollapsed ? 'fs-6' : ''}`}>Kebaya</NavLink>
              </li>
              <li><NavLink to="/products/beskaps" className={`link-body-emphasis d-inline-flex text-decoration-none rounded ${isCollapsed ? 'fs-6' : ''}`}>Beskap</NavLink>
              </li>
              <li><NavLink to="/products/gauns" className={`link-body-emphasis d-inline-flex text-decoration-none rounded ${isCollapsed ? 'fs-6' : ''}`}>Gaun</NavLink>
              </li>
            </ul>
          </div>
        </li>
